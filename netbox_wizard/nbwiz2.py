...
import pynetbox
from config_manager import ConfigManager, NetBoxConnection, AppPreferences, MasterPasswordDialog, MasterPasswordSetupDialog
...
class DeviceTableWidget(QTableWidget):
    ...
    def _populate_device_row(self, row: int, device: Dict, sites: List, roles: List, device_types: List, platforms: List):
